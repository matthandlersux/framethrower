...
i was in charge of the backend. it was a graph database, called mbrella, built in erlang based on a field of mathematics called information theory. the goal was to have a system that could store and lookup stories.
