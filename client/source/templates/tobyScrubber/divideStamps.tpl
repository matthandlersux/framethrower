...
template (timestamps::List b)::List (Tuple2 (Tuple2 Number Number) (List (Tuple2 Number Number))) {
	divisions = 18,
	js = function (divisions::Number, totalDuration::Number, timestamps::List b)::List (Tuple2 (Tuple2 Number Number) (List (Tuple2 Number Number))) {
