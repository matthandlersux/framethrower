var firebug = {
    version:[1.21,200809],
    el:{}, env:{ "cache":{}, "override":false, "css":"http://kodfabrik.com/firebug/Source/firebug-lite.css", "dIndex":"console", "height":295, "init":false, "minimized":false, "ml":false },
    init:function(_css){
        with(firebug){
            ...
            document.getElementsByTagName("head")[0].appendChild(
                new lib.element("link").attribute.set("rel","stylesheet").attribute.set("href",firebug.env.css||"http://getfirebug.com/releases/lite/1.2/firebug-lite.css").element
            );
