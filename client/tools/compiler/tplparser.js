...
switch( state )
{
	...
	case 51:
		if( info.src.charCodeAt( pos ) == 99 ) state = 53;
	...
	case 59:
		if( info.src.charCodeAt( pos ) == 108 ) state = 65;
		else state = -1;
		break;
	...
	case 61:
		if( info.src.charCodeAt( pos ) == 99 ) state = 67;
		else state = -1;
		break;
	...
	case 79:
		if( info.src.charCodeAt( pos ) == 103 ) state = 71;
		else state = -1;
		break;
