...
switch( state )
{
	case 0:
		...
		else if( info.src.charCodeAt( pos ) == 101 ) state = 198;
		else if( info.src.charCodeAt( pos ) == 115 ) state = 208;
		else if( info.src.charCodeAt( pos ) == 99 ) state = 216;
		else if( info.src.charCodeAt( pos ) == 114 ) state = 217;
		else if( info.src.charCodeAt( pos ) == 116 ) state = 225;
		else state = -1;
		break;
	...
	case 1:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 51;
	...
	case 15:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 71;
		else state = -1;
		match = 24;
		match_pos = pos;
		break;
	...
	case 20:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 94;
		else state = -1;
		match = 13;
		match_pos = pos;
		break;
	...
	case 21:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 155;
		else state = -1;
		match = 16;
		match_pos = pos;
		break;
	...
	case 22:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 103;
		else state = -1;
		match = 5;
		match_pos = pos;
		break;
	...
	case 23:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 158;
		else state = -1;
		match = 10;
		match_pos = pos;
		break;
	...
	case 29:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 111;
		else state = -1;
		match = 8;
		match_pos = pos;
		break;
	...
	case 30:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 117;
		else state = -1;
		match = 2;
		match_pos = pos;
		break;
	...
	case 33:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 128;
		else state = -1;
		match = 1;
		match_pos = pos;
		break;
	...
	case 35:
		...
		else if( info.src.charCodeAt( pos ) == 99 ) state = 209;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 37:
		...
		else if( info.src.charCodeAt( pos ) == 47 ) state = 148;
		else state = -1;
		match = 29;
		match_pos = pos;
		break;
	...
	case 52:
		...
		else if( info.src.charCodeAt( pos ) == 117 ) state = 222;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 54:
		...
		else if( info.src.charCodeAt( pos ) == 110 ) state = 228;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 69:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 69;
		else state = -1;
		break;
	...
	case 75:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 46 ) || ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 254 ) ) state = 149;
		else state = -1;
		break;
	...
	case 79:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 79;
		else state = -1;
		break;
	...
	case 82:
		if( info.src.charCodeAt( pos ) == 114 ) state = 91;
		else state = -1;
		break;
	...
	case 89:
		if( info.src.charCodeAt( pos ) == 108 ) state = 95;
		else state = -1;
		break;
	...
	case 97:
		if( info.src.charCodeAt( pos ) == 103 ) state = 156;
		else state = -1;
		break;
	...
	case 101:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 101;
		else state = -1;
		break;
	...
	case 104:
		if( info.src.charCodeAt( pos ) == 47 ) state = 154;
		else state = -1;
		break;
	...
	case 113:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 113;
		else state = -1;
		break;
	...
	case 116:
		if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 116;
	...
	case 122:
		if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 122;
	...
	case 124:
		if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 124;
	...
	case 126:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 126;
		else state = -1;
		break;
	...
	case 130:
		if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 130;
	...
	case 150:
		if( info.src.charCodeAt( pos ) == 97 ) state = 90;
		else state = -1;
		break;
	...
	case 154:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 154;
		else state = -1;
		break;
	...
	case 156:
		if( info.src.charCodeAt( pos ) == 103 ) state = 105;
		else state = -1;
		break;
	...
	case 170:
		...
		else if( ( info.src.charCodeAt( pos ) >= 9 && info.src.charCodeAt( pos ) <= 10 ) || info.src.charCodeAt( pos ) == 13 || info.src.charCodeAt( pos ) == 32 ) state = 170;
		else state = -1;
		match = 27;
		match_pos = pos;
		break;
	...
	case 198:
		...
		else if( info.src.charCodeAt( pos ) == 108 ) state = 132;
		else if( info.src.charCodeAt( pos ) == 120 ) state = 218;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 199:
		if( info.src.charCodeAt( pos ) == 10 ) state = 133;
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 9 ) || ( info.src.charCodeAt( pos ) >= 11 && info.src.charCodeAt( pos ) <= 254 ) ) state = 199;
		else state = -1;
		break;
	...
	case 200:
		...
		else if( info.src.charCodeAt( pos ) == 121 ) state = 175;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 202:
		...
		else if( info.src.charCodeAt( pos ) == 97 ) state = 182;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 203:
		...
		else if( info.src.charCodeAt( pos ) == 111 ) state = 185;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 204:
		...
		else if( info.src.charCodeAt( pos ) == 97 ) state = 188;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 205:
		...
		else if( info.src.charCodeAt( pos ) == 105 ) state = 190;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 206:
		...
		else if( info.src.charCodeAt( pos ) == 97 ) state = 192;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 207:
		...
		else if( info.src.charCodeAt( pos ) == 105 ) state = 194;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 210:
		...
		else if( info.src.charCodeAt( pos ) == 101 ) state = 202;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 211:
		...
		else if( info.src.charCodeAt( pos ) == 109 ) state = 203;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 212:
		...
		else if( info.src.charCodeAt( pos ) == 114 ) state = 204;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 213:
		...
		else if( info.src.charCodeAt( pos ) == 116 ) state = 205;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 214:
		...
		else if( info.src.charCodeAt( pos ) == 108 ) state = 206;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 215:
		...
		else if( info.src.charCodeAt( pos ) == 102 ) state = 207;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 216:
		...
		else if( info.src.charCodeAt( pos ) == 114 ) state = 210;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 217:
		...
		else if( info.src.charCodeAt( pos ) == 101 ) state = 211;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 218:
		...
		else if( info.src.charCodeAt( pos ) == 116 ) state = 212;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 219:
		...
		else if( info.src.charCodeAt( pos ) == 99 ) state = 213;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 220:
		...
		else if( info.src.charCodeAt( pos ) == 112 ) state = 214;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 221:
		...
		else if( info.src.charCodeAt( pos ) == 101 ) state = 215;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 222:
		...
		else if( info.src.charCodeAt( pos ) == 110 ) state = 219;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 223:
		...
		else if( info.src.charCodeAt( pos ) == 109 ) state = 220;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 224:
		...
		else if( info.src.charCodeAt( pos ) == 100 ) state = 221;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 225:
		...
		else if( info.src.charCodeAt( pos ) == 101 ) state = 223;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 226:
		...
		else if( info.src.charCodeAt( pos ) == 117 ) state = 224;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 227:
		...
		else if( info.src.charCodeAt( pos ) == 108 ) state = 226;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
	...
	case 228:
		...
		else if( info.src.charCodeAt( pos ) == 99 ) state = 227;
		else state = -1;
		match = 33;
		match_pos = pos;
		break;
